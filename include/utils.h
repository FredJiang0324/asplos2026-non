...
//Functions defined in header files should often be declared inline to avoid multiple definition errors
// template <typename T>
...
// template <typename T>
// inline double calculate_recall(uint32_t num_queries, float *gs_dist, uint32_t dim_gs, const std::vector<std::vector<std::vector<T>>> &query_result_values, const std::vector<std::vector<std::vector<T>>> &gt_values,
//                                           uint32_t recall_at){

//     double total_recall = 0;
//     size_t total_failed_at_recall1 = 0;
//     // Construct the file name
//     std::string fileName = "recallsOfRecall@" + std::to_string(recall_at) + ".txt";
//     // Open the file with the constructed file name
//     std::ofstream recallWriter(fileName);
//     //num_queries = 1;
//     //std::cout << "Recall: "<< recall_at << std::endl;
//     //std::cout << "Number of fetched vectors: "<< query_result_values[0].size() << std::endl;
//     for (size_t i = 0; i < num_queries; i++)
//     {   
//         double hit = 0;
//         //const auto &res_vecs = query_result_values[i];//this creates a constant reference to the element at index i 
//         auto res_vecs = query_result_values[i];//This creates a new variable res_vecs which is a copy of the element at index i in 
...
//         if (res_vecs.size() > recall_at)
//         {
//             res_vecs.resize(recall_at);
//         }

//         // if(res_vecs.size() < recall_at){
//         //     std::cout << "Not enough fetching results" <<std::endl;
//         // }
...
//         //print out the values of gt_vecs and res_vecs
//         // if (i == 0 && recall_at == 100) {
//         //     std::cout << "Query Index: 0" << std::endl;

//         //     if (gs_dist != nullptr) {
//         //         std::cout << "Ground Truth Distances:" << std::endl;
//         //         float *gt_dist_vec = gs_dist + dim_gs * i;  // Get distance vector for query 0
//         //         for (size_t j = 0; j < dim_gs; j++) {
//         //             std::cout << gt_dist_vec[j] << " ";
//         //         }
//         //         std::cout << std::endl;
//         //     }

//         //     std::cout << "Ground Truth Vectors (gt_vecs):" << std::endl;
//         //     for (const auto &gt_vec : gt_vecs) {
//         //         for (const auto &val : gt_vec) {
//         //             std::cout << val << " ";
//         //         }
//         //         std::cout << std::endl;
//         //     }

//         //     std::cout << "Retrieved Vectors (res_vecs):" << std::endl;
//         //     for (const auto &res_vec : res_vecs) {
//         //         for (const auto &val : res_vec) {
//         //             std::cout << val << " ";
//         //         }
//         //         std::cout << std::endl;
//         //     }
...
//         // if (recall_at == 1 && cur_recall == 0){
//         //     std::cout << "Recall@"<< recall_at <<" failed at query "<< i << std::endl;
//         //     total_failed_at_recall1++;
//         // }

//         total_recall += cur_recall;
// //This below is to display the values of the gt node
//         // if (recall_at == 5){
//         //    const auto& third_element = gt_vecs[2]; // Access the first element of gt_vecs

//         //     // Loop through the first element
//         //     for (const auto& element : third_element) {
//         //         // Do something with element
//         //         std::cout << element << " ";
//         // }
//         // std::cout << std::endl;
//         // }
//         recallWriter << hit / recall_at * 100.0 << std::endl;
//         //recallWriter << hit << std::endl;
//     }
//     recallWriter.close();
//     if (recall_at == 1){
//         std::cout << "Total number of failed query at Recall@1 "<< total_failed_at_recall1 << std::endl;
//     }
//     return total_recall / num_queries / recall_at * 100.0;//return percent not percentage

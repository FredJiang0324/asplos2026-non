...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        // Optional parameters
        ///MARK: clean those no needed options
        ...
        ("sample_ratio", po::value<float>(&sample_ratio)->default_value(0), "Ratio of sampled points for filtering.");
        //("page_degree,PD", po::value<uint32_t>(&PD)->default_value(0), "Page graph degree PD.")
        //("num_PQ_chunks", po::value<uint32_t>(&num_PQ_chunks)->default_value(0), "Number of PQ chunks used for compression.")
        //("page_size", po::value<uint64_t>(&page_size)->default_value(4), "Page size for disk index. (default: 4096)")
        //("use_ooc", po::bool_switch()->default_value(false), "Use OOC to generate final page ANN index file");
    ...
    try
    {
        ...
        //                                                  universal_label, filter_threshold, Lf, page_size);
        ...
        //             use_filters, label_file, universal_label, filter_threshold, Lf, page_size);

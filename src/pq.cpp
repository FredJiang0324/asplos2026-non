...
//     float *dists_out)
// {
//     // This function is called by multiple outer threads independently.
...
//         // Inner parallelization: 2 threads per query call
//         #pragma omp parallel for num_threads(2) reduction(+:dist) schedule(static)
//         for (size_t chunk = 0; chunk < pq_nchunks; chunk++)
//         {
